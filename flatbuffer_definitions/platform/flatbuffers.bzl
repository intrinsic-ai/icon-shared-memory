...
```build
load("//flatbuffer_definitions/platform:flatbuffers.bzl", "cc_flatbuffers_library", "flatbuffers_library")
...
```build
load("//flatbuffer_definitions/platform/flatbuffers:flatbuffers.bzl", "cc_flatbuffers_library", "flatbuffers_library")
...
```build
load("//flatbuffer_definitions/platform/flatbuffers:flatbuffers.bzl", "cc_lite_flatbuffers_library", "flatbuffers_library")
...
```build
load("//flatbuffer_definitions/platform/flatbuffers:flatbuffers.bzl", "py_flatbuffers_library", "flatbuffers_library")
